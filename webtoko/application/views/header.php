...
<head>
  ...
  <meta name="description" content="Toko Aneka Sutra Makassar">
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="<?php echo base_url() ;?>home" class="logo">Aneka <span class="lite">Sutra </span></a>
      <!--logo end-->
      ...
      <div class="top-nav notification-row">
        ...
        <ul class="nav pull-right top-menu">
         ...
         <!--  <li id="alert_notificatoin_bar" class="dropdown">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="<?php echo base_url() ;?>#">
                            <span class="username" style="font-size: 20px;font-style:italic;"><?php echo ucwords($ses['nama_user']) ?></span>
                            <b class="caret"></b>
                        </a>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="<?php echo base_url() ;?>jenis_produk">Jenis Produk</a></li>
              <li><a href="<?php echo base_url() ;?>produk">Produk</a></li>
              <li><a href="<?php echo base_url() ;?>order">Pesanan</a></li>
