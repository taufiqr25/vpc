                ...
                <div class="col-lg-12">
                    ...
                    <div class="user-data m-b-30">
                        <h3 class="title-3 m-b-30">
                            <i class="fas fa-shopping-cart"></i>Data Order</h3>
                            ...
                            <table class="table">
                                ...
                                <tbody id="tbody">
                                    ...
                                    if($data_order->num_rows() > 0){
                                        foreach ($data_order->result() as $data) {?>
                                    <tr>
                                        <td>
                                            <label class="au-checkbox">
                                                <input type="checkbox">
...
function get_data() {
    $.ajax({
        url: '<?php echo base_url() ?>order/get_data'
    }).done(function(response){
        ...
        if(data.length > 0){
            for(i=0;i<data.length;i++){
                ...
                tbody += '<td>'+data[i].nama+'</td>';
                tbody += '<td>'+data[i].nama_barang+'</td>';
                tbody += '<td>'+data[i].jumlah+'</td>';
                tbody += '<td>'+data[i].waktu+'</td>';
